...
_Example: ‘Fake and real news’ dataset available from the Kaggle official website._ 
...
- [2] Briefly described. [3] Adequately described. 
...
- [4] Methods and metrics clearly described with convincing rationale. [5] Exceptional work which includes the above but goes beyond what would be expected from a student at this level. 
